package com.gambino_serra.condomanager_condomino.Model_old.HTTPRequest.Condomino;
...
public class HTTPRequestCondominio {
    ...
    private static final String KEY_DB_REQUEST2 = "http://damicogianluca.altervista.org/get_condominio_from_condomino.php";
    ...
    public static void getCondominioFromCondomino(final String username, final Context context, Response.Listener<String> listener, Response.ErrorListener errorListener){
