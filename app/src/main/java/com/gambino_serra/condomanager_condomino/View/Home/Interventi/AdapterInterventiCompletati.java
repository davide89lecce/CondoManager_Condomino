...
public class AdapterInterventiCompletati extends RecyclerView.Adapter<AdapterInterventiCompletati.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            this.mLogoStato = (ImageView) itemView.findViewById(R.id.Logo_Interv);
            this.mBackStato = (ImageView) itemView.findViewById(R.id.Back_Logo);
            this.mCircle = (ImageView) itemView.findViewById(R.id.circle);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(com.gambino_serra.condomanager_condomino.View.Home.Interventi.InterventiCompletati.myOnClickListener);
