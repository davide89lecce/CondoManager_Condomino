...
import com.gambino_serra.condomanager_condomino.View.Home.Interventi.AdapterCardsBachecaSegnalazioni;
                ...
                if(dataSnapshot.getKey().toString().equals("stabile")){
                    ...
                    prova.addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                            ...
                            adapter = new AdapterCardsBachecaSegnalazioni(interventi);
