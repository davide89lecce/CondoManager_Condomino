...
public class AdapterCardsSegnalazioniRisolte extends RecyclerView.Adapter<AdapterCardsSegnalazioniRisolte.MyViewHolder> {
    ...
    public AdapterCardsSegnalazioniRisolte(ArrayList<Segnalazione> data) {
        this.dataSet = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(SegnalazioniRisolte.myOnClickListener);
