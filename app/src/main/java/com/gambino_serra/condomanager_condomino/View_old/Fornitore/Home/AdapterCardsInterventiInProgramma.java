...
public class AdapterCardsInterventiInProgramma extends RecyclerView.Adapter<AdapterCardsInterventiInProgramma.MyViewHolder> {
    ...
    public AdapterCardsInterventiInProgramma(ArrayList<Segnalazione> data) {
        this.dataSet = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(InterventiInProgramma.myOnClickListener);
