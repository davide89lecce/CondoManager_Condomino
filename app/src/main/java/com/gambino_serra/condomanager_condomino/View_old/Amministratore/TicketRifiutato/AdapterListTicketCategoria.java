package com.gambino_serra.condomanager_condomino.View_old.Amministratore.TicketRifiutato;
...
public class AdapterListTicketCategoria extends RecyclerView.Adapter<AdapterListTicketCategoria.MyViewHolder> {

    private ArrayList<DataTicketCategoria> dataSet;
    int row;
    ...
    public AdapterListTicketCategoria(ArrayList<DataTicketCategoria> data, Context context, Activity activity) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(TicketCategoria.myOnClickListener);
