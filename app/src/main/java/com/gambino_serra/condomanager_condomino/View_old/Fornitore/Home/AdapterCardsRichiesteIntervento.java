...
public class AdapterCardsRichiesteIntervento extends RecyclerView.Adapter<AdapterCardsRichiesteIntervento.MyViewHolder> {
    ...
    public AdapterCardsRichiesteIntervento(ArrayList<Segnalazione> data) {
        this.dataSet = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(RichiesteIntervento.myOnClickListener);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        switch(stato) {
            ...
            case "A":
                imageView.setImageResource(R.drawable.edificio);
                break;
